...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, ethereum, account }) => {
  ...
  const totalValue: BigNumber = useMemo(() => {
    ...
    if (farm.quoteTokenSymbol === QuoteToken.Pixiu) {
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('PixiuSWAP', '')
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'Pixiu' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
