  ...
  const farmsList = useCallback(
    (farmsToDisplay, removed: boolean) => {
      ...
      const farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        } else if (farm.quoteTokenSymbol === QuoteToken.Pixiu) {
  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="secondary" mb="50px" style={{ textAlign: 'center' }}>
        {TranslateString(696, 'Stake LP tokens to earn Pixiu')}
      </Heading>
      ...
      <Image src="/images/space_Banner Mobile.svg" alt="PixiuSwap illustration" width={949} height={384} responsive />
    </Page>
  )
}
