...
import { salePixiuBnb } from 'utils/callHelpers'
...
const IfoCard: React.FC<IfoCardProps> = ({ ifo }) => {
  ...
  const onBuyNow = useCallback(async () => {
    ...
    try {
      await salePixiuBnb(contract,state.tempTextBoxValue,account)
      ...
      <CardBody>
        ...
        {/* {account && (
          <>
            ...
            />
            <Text fontSize= "20px">{`You will get ${state.tempTextBoxValue * 220}   Pixiu Tokens `}</Text>
